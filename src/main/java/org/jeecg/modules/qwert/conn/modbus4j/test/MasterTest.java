...
public class MasterTest {
  ...
  //          readInputRegistersTest(master, slaveId, 2, 1);
            ...
            readHoldingRegistersTest(master, slaveId, 5, 1);
...
/*
             batch.addLocator("hr1",
                     BaseLocator.holdingRegister(slaveId, 21, DataType.FOUR_BYTE_FLOAT));
             batch.addLocator("hr2",
                     BaseLocator.holdingRegister(slaveId, 12288, DataType.FOUR_BYTE_FLOAT_SWAPPED));
