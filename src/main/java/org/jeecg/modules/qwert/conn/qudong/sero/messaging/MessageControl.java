...
public class MessageControl implements DataConsumer {
    ...
    public IncomingResponseMessage send(OutgoingRequestMessage request, int timeout, int retries) throws IOException {
        ...
        EncapMessageRequest em = (EncapMessageRequest) request;
        this.qr=em.getModbusRequest();
...
//    		String putIn= "~00P003STB"; //台达
  //  		String putIn= "Q1\r"; //科士达
    ...
    public void send(OutgoingResponseMessage response) throws IOException {
        String putIn =null;
        putIn = "~21036000d03000d201f40014003200000000012c0096032000c800e60078f3f3\r";
//            putIn = "!9E0000\r"; //M7000d
//           putIn = "(208.4 140.0 208.4 034 59.9 2.05 35.0 00110000\r"; //科士达
//        putIn = "~00D0250;0;1;;;000;2740;;029;100";//台达
		byte[] data=putIn.toUpperCase().getBytes();
        write(data);
    ...
    public void data(byte[] b, int len) {
        ...
        while (true) {
            ...
            try {
                ...
                IncomingMessage message = messageParser.parseMessage(dataBuffer,this.qr);
