...
abstract public class BaseMessageParser implements MessageParser {
    ...
    /** {@inheritDoc} */
    @Override
    public IncomingMessage parseMessage(ByteQueue queue, QwertRequest qr) throws Exception {
        try {
            return parseMessageImpl(queue,qr);
        }
     ...
     */
    abstract protected IncomingMessage parseMessageImpl(ByteQueue queue, QwertMessage qr) throws Exception;
}
