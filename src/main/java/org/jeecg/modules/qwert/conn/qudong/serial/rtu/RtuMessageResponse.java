...
public class RtuMessageResponse extends RtuMessage implements OutgoingResponseMessage, IncomingResponseMessage {
    static RtuMessageResponse createDianzongMessageResponse(ByteQueue queue,QwertMessage qr) throws QudongTransportException {
//        ByteQueue msgQueue = QwertAsciiUtils.getUnDianzongMessage(queue);
        QwertResponse response = QwertResponse.createQwertResponse(queue,qr);
