...
public class QwertPointProtocolItemController extends JeecgController<QwertPointProtocolItem, IQwertPointProtocolItemService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "qwert_point_protocol_item-分页列表查询")
	@ApiOperation(value="qwert_point_protocol_item-分页列表查询", notes="qwert_point_protocol_item-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "qwert_point_protocol_item-添加")
	@ApiOperation(value="qwert_point_protocol_item-添加", notes="qwert_point_protocol_item-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "qwert_point_protocol_item-编辑")
	@ApiOperation(value="qwert_point_protocol_item-编辑", notes="qwert_point_protocol_item-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "qwert_point_protocol_item-通过id删除")
	@ApiOperation(value="qwert_point_protocol_item-通过id删除", notes="qwert_point_protocol_item-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "qwert_point_protocol_item-批量删除")
	@ApiOperation(value="qwert_point_protocol_item-批量删除", notes="qwert_point_protocol_item-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "qwert_point_protocol_item-通过id查询")
	@ApiOperation(value="qwert_point_protocol_item-通过id查询", notes="qwert_point_protocol_item-通过id查询")
